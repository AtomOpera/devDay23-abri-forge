...
export async function onIssueCreated(event, context) {
  ...
  // await storeIssue( event.issue.key, event.issue.fields.summary );
  ...
  // TODO: Exercise 7 - push the payload to the queue using queue.push
  //                    with a delay of 0.5 seconds before processing the event
  // await queue.push(<eventPayload>, { delayInSeconds: 0.5});
